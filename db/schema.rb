...
ActiveRecord::Schema.define(version: 2020_09_07_015130) do

  create_table "mappings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
